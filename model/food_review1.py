...
def initFoodReviews1 ():
    ...
    """
    reviews = [
        FoodReview1("Pizza", "Delicious and cheesy!", "5"),
        FoodReview1("Burger", "Juicy and filling.", "4"),
        FoodReview1("Sushi", "Fresh and tasty.", "5"),
        FoodReview1("Pasta", "Creamy and delightful.", "4.5"),
        FoodReview1("Salad", "Healthy but could use more flavor.", "3")
    ]
