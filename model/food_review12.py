...
def initFoodReviews12 ():
    ...
    """
    reviews = [
        FoodReview12("Pizza", "Delicious and cheesy!", "5"),
        FoodReview12("Burger", "Juicy and filling.", "4"),
        FoodReview12("Sushi", "Fresh and tasty.", "5"),
        FoodReview12("Pasta", "Creamy and delightful.", "4.5"),
        FoodReview12("Salad", "Healthy but could use more flavor.", "3")
    ]
